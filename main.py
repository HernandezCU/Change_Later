    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                player_speed_x, player_speed_y = get_movement(event=event.type, key=event.key)
        ...
        pygame.draw.rect(screen, CONSTANTS.COLOR_PLAYER, (player_x, player_y, CONSTANTS.PLAYER_SIZE, CONSTANTS.PLAYER_SIZE))
